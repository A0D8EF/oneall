    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good', models.ManyToManyField(related_name='question_good', to=settings.AUTH_USER_MODEL, verbose_name='いいねしたユーザー')),
                ('tag', models.ManyToManyField(related_name='question_tag', to='qa.tag', verbose_name='タグ')),
